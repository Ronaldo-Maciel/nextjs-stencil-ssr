...
const myComponentCss = "/*!@:host*/.sc-my-component-h{display:block}/*!@h1*/h1.sc-my-component{color:#333;font-size:18px}";
...
class MyComponent {
  ...
  render() {
    return (hAsync("div", null, hAsync("p", null, "Hello, World! I'm ", this.getText()), hAsync("h1", null, "Open your page source from browser, this \"h1\" element is present")));
  }
